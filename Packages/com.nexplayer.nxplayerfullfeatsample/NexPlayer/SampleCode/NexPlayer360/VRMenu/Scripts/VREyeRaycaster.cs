...
namespace NexPlayerSample
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        private void EyeRaycast()
        {
            ...
            {
                NexVRInteractableSeekBar interactibleSeekBar = hit.collider.GetComponent<NexVRInteractableSeekBar>(); //pass the hit to the seekbar
                if (interactibleSeekBar)
                    interactibleSeekBar.SetLastHit(hit);
