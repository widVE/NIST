...
namespace OpenCVForUnity.Editor
{
    ...
    public class OpenCVForUnityExampleAssetsDownloaderWindow : EditorWindow
    {
        ...
        static Dictionary<string, string>[] files = {
            ...
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ColorizationExample" }, { "url", "https://eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v2/colorization_release_v2.caffemodel" } , { "filename", "colorization_release_v2.caffemodel" }, { "sha", "21e61293a3fa6747308171c11b6dd18a68a26e7f" } },
            ...
            //DaSiamRPNTrackerExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "DaSiamRPNTrackerExample" }, { "url", "https://www.dropbox.com/s/rr1lk9355vzolqv/dasiamrpn_model.onnx?dl=1" } , { "filename", "dasiamrpn_model.onnx" }, { "sha", "91b774fce7df4c0e4918469f0f482d9a27d0e2d4" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "DaSiamRPNTrackerExample" }, { "url", "https://www.dropbox.com/s/999cqx5zrfi7w4p/dasiamrpn_kernel_r1.onnx?dl=1" } , { "filename", "dasiamrpn_kernel_r1.onnx" }, { "sha", "bb64620a54348657133eb28be2d3a2a8c76b84b3" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "DaSiamRPNTrackerExample" }, { "url", "https://www.dropbox.com/s/qvmtszx5h339a0w/dasiamrpn_kernel_cls1.onnx?dl=1" } , { "filename", "dasiamrpn_kernel_cls1.onnx" }, { "sha", "e9ccd270ce8059bdf7ed0d1845c03ef4a951ee0f" } },
            ...
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "LibFaceDetectionV2Example" }, { "url", "https://github.com/ShiqiYu/libfacedetection/raw/96a7cc0bbfcf05bac17c2df52bee0e8ba6c72964/models/caffe/yufacedetectnet-open-v2.caffemodel" } , { "filename", "yufacedetectnet-open-v2.caffemodel" }, { "sha", "3716bd48064f7f56410470f875c9a5c6264ca31c" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "LibFaceDetectionV2Example" }, { "url", "https://github.com/ShiqiYu/libfacedetection/raw/96a7cc0bbfcf05bac17c2df52bee0e8ba6c72964/models/caffe/yufacedetectnet-open-v2.prototxt" } , { "filename", "yufacedetectnet-open-v2.prototxt" }, { "sha", "d8afd224aa1cc41c922075dc95f67852848352c0" } },
            //LibFaceDetectionV3Example
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "LibFaceDetectionV3Example" }, { "url", "https://github.com/opencv/opencv_zoo/raw/4563a91ba98172b14d7af8bce621b6d1ae7ae0c6/models/face_detection_yunet/face_detection_yunet_2022mar.onnx" }, { "filename", "face_detection_yunet_2022mar.onnx" }, { "sha", "dfe691ae0c8e38d39d1a437e3f7e5fda7b256bdd" } },
            //ResnetSSDFaceDetectionExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ResnetSSDFaceDetectionExample" }, { "url", "https://github.com/opencv/opencv_3rdparty/raw/dnn_samples_face_detector_20170830/res10_300x300_ssd_iter_140000.caffemodel" } , { "filename", "res10_300x300_ssd_iter_140000.caffemodel" }, { "sha", "15aa726b4d46d9f023526d85537db81cbc8dd566" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "ResnetSSDFaceDetectionExample" }, { "url", "https://github.com/opencv/opencv/raw/master/samples/dnn/face_detector/deploy.prototxt" } , { "filename", "deploy.prototxt" }, { "sha", "7e5cc2cefc23908176a73f58c9b0ea7e5c74db2d" } },
            ...
            //LightweightPoseEstimationExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "LightweightPoseEstimationExample" }, { "url", "https://github.com/CMU-Perceptual-Computing-Lab/openpose/raw/master/examples/media/COCO_val2014_000000000589.jpg" } , { "filename", "COCO_val2014_000000000589.jpg" }, { "sha", "e078403d1a09d0ef392c29741cb0c358c3a76322" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "LightweightPoseEstimationExample" }, { "url", "https://drive.google.com/uc?export=dowload&id=1--Ij_gIzCeNA488u5TA4FqWMMdxBqOji" } , { "filename", "lightweight_pose_estimation_201912.onnx" }, { "sha", "5960f7aef233d75f8f4020be1fd911b2d93fbffc" } },
            //HandPoseEstimationExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "HandPoseEstimationExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/6c68bc48c6f96042b29b3425174e431ccac38376/models/palm_detection_mediapipe/palm_detection_mediapipe_2023feb.onnx" } , { "filename", "palm_detection_mediapipe_2023feb.onnx" }, { "sha", "b9e6df1d4f93ee1b0b4f5c99a2f88716ccd7ca9a" } },
            ...
            //HumanSegmentationExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "HumanSegmentationExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/6a66e0d6e47a693e6d0dd01bbb18e920f3fbae75/models/human_segmentation_pphumanseg/human_segmentation_pphumanseg_2021oct.onnx" } , { "filename", "human_segmentation_pphumanseg_2021oct.onnx" }, { "sha", "323394f6648c5dbe0591a270a2d82343aecea317" } },
            //MobileNetSSDExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "MobileNetSSDExample" }, { "url", "https://github.com/chuanqi305/MobileNet-SSD/raw/master/images/004545.jpg" } , { "filename", "004545.jpg" }, { "sha", "2b0c65f59a9f9071f1e7de452f0c2004e8d55b7b" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "MobileNetSSDExample" }, { "url", "https://github.com/PINTO0309/MobileNet-SSD-RealSense/raw/master/caffemodel/MobileNetSSD/MobileNetSSD_deploy.caffemodel" } , { "filename", "MobileNetSSD_deploy.caffemodel" }, { "sha", "994d30a8afaa9e754d17d2373b2d62a7dfbaaf7a" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "MobileNetSSDExample" }, { "url", "https://github.com/chuanqi305/MobileNet-SSD/raw/f5d072ccc7e3dcddaa830e9805da4bf1000b2836/MobileNetSSD_deploy.prototxt" } , { "filename", "MobileNetSSD_deploy.prototxt" }, { "sha", "d77c9cf09619470d49b82a9dd18704813a2043cd" } },
            ...
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "OpenPoseExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/8a42017a12fe9ed80279737c0b903307371b0e3d/models/text_recognition_crnn/charset_36_EN.txt" } , { "filename", "charset_36_EN.txt" }, { "sha", "e1562f54307e089f23ce7586d55c994666ed44ac" } },
            //YOLOv4ObjectDetectionExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv4ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv4ObjectDetectionExample" }, { "url", "https://raw.githubusercontent.com/AlexeyAB/darknet/0faed3e60e52f742bbef43b83f6be51dd30f373e/cfg/yolov4-tiny.cfg" } , { "filename", "yolov4-tiny.cfg" }, { "sha", "b161c2b0984b0c3b466c04b0d6cb3e52f06d93dd" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv4ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/releases/download/yolov4/yolov4-tiny.weights" } , { "filename", "yolov4-tiny.weights" }, { "sha", "451caaab22fb9831aa1a5ee9b5ba74a35ffa5dcb" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv4ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
            //YOLOv7ObjectDetectionExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv7ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv7ObjectDetectionExample" }, { "url", "https://raw.githubusercontent.com/AlexeyAB/darknet/0faed3e60e52f742bbef43b83f6be51dd30f373e/cfg/yolov7-tiny.cfg" } , { "filename", "yolov7-tiny.cfg" }, { "sha", "883a74987b2a4a8e725b2929826d09a1250373b6" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv7ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/releases/download/yolov4/yolov7-tiny.weights" } , { "filename", "yolov7-tiny.weights" }, { "sha", "f3212b63af4764b67da6155f4950567f2183556b" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOv7ObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
            //YOLOXObjectDetectionExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOXObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOXObjectDetectionExample" }, { "url", "https://github.com/Megvii-BaseDetection/YOLOX/releases/download/0.1.1rc0/yolox_tiny.onnx" } , { "filename", "yolox_tiny.onnx" }, { "sha", "45985579a307aae54c7b54ca257bc0b48606deac" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "YOLOXObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
            //NanoDetPlusObjectDetectionExample
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "NanoDetPlusObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/person.jpg" } , { "filename", "person.jpg" }, { "sha", "19281b65c5bd43381dfe04e637e78d0cf0b05cbe" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "NanoDetPlusObjectDetectionExample" }, { "url", "https://github.com/RangiLyu/nanodet/releases/download/v1.0.0-alpha-1/nanodet-plus-m_416.onnx" } , { "filename", "nanodet-plus-m_416.onnx" }, { "sha", "79ed0edaab7ea00fe76662aa9d954f0fa5ff5d28" } },
            new Dictionary<string, string>() { { "module", "dnn" }, { "name", "NanoDetPlusObjectDetectionExample" }, { "url", "https://github.com/AlexeyAB/darknet/raw/0faed3e60e52f742bbef43b83f6be51dd30f373e/data/coco.names" } , { "filename", "coco.names" }, { "sha", "b769c7d769385f7640be484dd9c7537b6fb2f35e" } },
            ...
            //FaceDetectorYNWebCamTextureExample
            new Dictionary<string, string>() { { "module", "objdetect" }, { "name", "FaceDetectorYNWebCamTextureExample" }, { "url", "https://github.com/opencv/opencv_zoo/raw/4563a91ba98172b14d7af8bce621b6d1ae7ae0c6/models/face_detection_yunet/face_detection_yunet_2022mar.onnx" } , { "filename", "face_detection_yunet_2022mar.onnx" }, { "sha", "dfe691ae0c8e38d39d1a437e3f7e5fda7b256bdd" } },
