...
winrt::Windows::Foundation::IAsyncAction VideoCameraFrameProcessor::InitializeAsync(
...
winrt::Windows::Foundation::IAsyncAction VideoCameraFrameProcessor::StartAsync()
{
    m_fExit = false;
